<template>
  <div style="width: 100%; height: 100vh;background-color: darkslateblue; overflow: hidden">
    <div style="width: 400px; margin: 100px auto">
      ...
      <el-form  ref="rule_form" :model="rule_form" size="normal" :rules="rules">
        ...
        <el-form-item prop="confirm">
          <el-input v-model="rule_form.confirm" show-password>
            <template #prefix>
              <el-icon class="ui-icon-locked" style="width: 100%;height: 100%"><lock /></el-icon>
            </template>
          </el-input>
...
export default {
  ...
  methods:{
    register(){
      if(this.rule_form.password !== this.rule_form.confirm){
        this.$message({
          type:"error",
          message:"两次密码输入不一致"
        })
